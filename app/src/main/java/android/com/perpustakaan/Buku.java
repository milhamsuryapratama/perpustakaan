...
public class Buku extends AppCompatActivity {
  ...
  //  ImageView imgBuku;
    ...
    private void cariBuku() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Koneksi.cari_buku,
                    ...
                    public void onResponse(String response) {
                        if(response.contains("1")) {
                            try {
                                ...
                                adapter=new AdapterBuku(Buku.this,tampil);
                                rv_buku.setAdapter(adapter);
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put(Koneksi.judul_buku,cr_bk);
                return params;
            }
        };
